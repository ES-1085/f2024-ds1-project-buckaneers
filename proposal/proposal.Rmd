...
ggplot(Data2_clean, mapping = aes(x = mnr_source, y = p_h, fill = mnr_solid))+
  ...
  labs(title = "pH levels of soil with different manure sources", x = "Manure Type", y = "pH", fill = "State of Manure")+

  geom_hline(yintercept = 6.8, linetype = "dotted", color = "black", size = 0.5) +
  geom_hline(yintercept = 7.5, linetype = "dotted", color = "black", size = 0.5) 
