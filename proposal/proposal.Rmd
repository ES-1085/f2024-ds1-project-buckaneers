...
ggplot(Data2_clean, mapping = aes(x = mnr_source, y = p_h, fill = mnr_solid)) +
 ...
 scale_fill_manual(values = c(  "S" = "#404688FF", "L" = "#21908CFF",  "B" = "#7AD151FF", "NONE" = "#FDE725FF"),
                    breaks = c("S","L","B","NONE"),
...
```{r water drainage correlation to tilling of the soil, fig.alt= a horizontal violin plot is showing the correlation of tillage amount and frequencey compared to the amount of water drainage on a scale of 1-7: 1 - very poorly drained, 2 - poorly drained, 3 - somewhat poorly drained, 4 - moderately well drained, 5 - well drained, 6 - somewhat excessively well drained, 7 - excessively drained.}
...
ggplot(aes(fill = drainage, y = springfall_till_passes)) + 
  ...
  scale_fill_manual(values = c(  "1" = "#440154FF", "2" = "#443A83FF",  "3" = "#3B528BFF", "4" = "#2C728EFF", "5" = "#24868EFF", "6" = "#1F9A8AFF", "7" = "#47C16EFF"),
                    breaks = c("1","2","3","4","5","6","7"),
                    labels = c("Very poorly drained", "Poorly drained", "Somewhat poorly drained", "Moderately well drained", "Well drained", "Somewhat excessively well drained", "Excessively drained"))+
