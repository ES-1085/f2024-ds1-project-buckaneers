...
```{r Nitrogen Plot}
Data2_clean|>
filter(Ncredit_lb/ac  )|> 
mutate(Ncredit_lb/ac  fct_relevel(Ncredit_lb/ac, "none", "beef","dairy", "chicken", "swine", "turkey" ))|>

  
ggplot(Data2_clean, mapping = aes(x = mnr_source, y = Ncredit_lb/ac, color = mnr_solid))+
         geom_violin()+
